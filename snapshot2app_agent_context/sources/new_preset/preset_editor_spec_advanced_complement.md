# TODO - FAIRE PLUS TARD - COMPLEXE


# Complements de spécifications au design
Ce document est un complément de règles qui ne sont pas visibles dans le fichier de design preset_editor_design_advanced.json. 
...
Le fichier de design preset_editor_design_advanced.json et cette spécification se concentrent sur la vue "ADVANCED". L'écran et la vue "SIMPLE" ont déjà été développés. 

La génération doit se concentrer sur le panel "ADVANCED" de l'écran déjà développé : 
- ne pas retroucher la structure de l'écran
- ne pas toucher à la vue "SIMPLE"
...
## Interactions - déjà développées dans l'écran Preset.
**Tap sur SIMPLE / ADVANCED**
Un tap sur le bouton ADVANCED dans la barre de menu affiche la vue ADVANCED.
